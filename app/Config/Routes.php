...
$routes->post('veterinarios/update', 'VeterinariosController::update');
...
$routes->post('usuarios/update', 'UsuariosController::update');
...
$routes->post('colonias/update', 'ColoniasController::update');
...
$routes->post('especies/update', 'EspeciesController::update');
...
$routes->post('animales/update', 'AnimalesController::update');
